...
const teamsData = [
  {
    ...
    githubLink: 'https://github.com/Sachin-kumar987',
    linkedinLink: 'https://www.linkedin.com/in/sachin-kumar232',
    name: 'Gabriel Hart',
    designation: 'CEO',
                    ...
                    <div className='overlay'>
                      <div className='socials'>
                        <ul>
                          ...
                          <li><a href={teams.githubLink}><i className="fa-brands fa-github"></i></a></li>
